...
// Evaluate
await UTILITY_MODULE.waitForElements(`#m_prereq4094_0`, {timeout:5});
COURSE_MODULE.evaluate_req("4094_0", "prereq", UTILITY_MODULE, dv, tp);
COURSE_MODULE.evaluate_req("4094_0", "coreq", UTILITY_MODULE, dv, tp);
// --------------------------------
}; main();
```
